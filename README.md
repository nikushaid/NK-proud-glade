...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/proud-glade-70f2
```

A live public deployment of this template is available at [https://proud-glade-70f2.templates.workers.dev](https://proud-glade-70f2.templates.workers.dev)
